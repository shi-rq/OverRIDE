...
class ExecuteModelState(NamedTuple):
    ...
    q_logits_next: torch.Tensor | None
    q_indices: list[int] | None


class GPUModelRunnerForOverRIDE(
    ...
    def execute_model(
        ...
        with record_function_or_nullcontext("gpu_model_runner: postprocess"):
            ...
            if not self.broadcast_pp_output:
                ...
                print('!'*100, 'Rare case: not get_pp_group().is_last_rank')
                # Rare case.
    ...
    def sample_tokens(
        ...
        # OverRIDE: Update reweighting head after sampling
        if q_logits_next is not None and q_indices is not None:
            sampled_token_ids_for_update = sampler_output.sampled_token_ids
            self.model.logits_processor.update_reweighting_head(
                q_logits_next, sampled_token_ids_for_update, q_indices
            )
